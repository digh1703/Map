...
public class MapsNaverActivity extends AppCompatActivity implements NaverMap.OnMapClickListener, Overlay.OnClickListener, OnMapReadyCallback, NaverMap.OnCameraChangeListener, NaverMap.OnCameraIdleListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(this);//지도데이터를 비동기적으로 불러온다.
    }
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
          ...
          infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
              ...
              protected View getContentView(@NonNull InfoWindow infoWindow) {
                  ...
                  View view=View.inflate(MapsNaverActivity.this,R.layout.view_info_windwo,null);
                  ...
                  if("plenty".equalsIgnoreCase(store.remain_stat)){
                      ...
                      ((TextView) view.findViewById(R.id.stock)).setText("30 이상 100개 미만");
                  }
    ...
    public void onRequestPermissionReuslt(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults){
        ...
        if(result.stores !=null&& result.stores.size()>0){
            for(Store store: result.stores){
                ...
                if("plenty".equalsIgnoreCase(store.remain_stat)){
                    ...
                    marker.setIcon(OverlayImage.fromResource(R.drawable.marker_black));
                }
